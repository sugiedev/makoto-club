...
export const SearchArea = (): JSX.Element => {
  return (
    <div className="space-y-3 rounded-md bg-white p-3">
      <MultipleSelect
        options={[
          { value: "混合ソープ", label: "混合ソープ" },
          { value: "S着ソープ", label: "S着ソープ" },
          { value: "NSソープ", label: "NSソープ" },
          { value: "デリヘル", label: "デリヘル" },
          { value: "ホテヘル", label: "ホテヘル" },
          { value: "箱ヘル", label: "箱ヘル" },
          { value: "メンズエステ(ヌキあり)", label: "メンズエステ(ヌキあり)" },
          { value: "メンズエステ(ヌキなし)", label: "メンズエステ(ヌキなし)" },
          { value: "セクキャバ", label: "セクキャバ" },
          { value: "いちゃキャバ", label: "いちゃキャバ" },
          { value: "AV", label: "AV" },
          { value: "個撮", label: "個撮" },
        ]}
        placeholder="業種"
